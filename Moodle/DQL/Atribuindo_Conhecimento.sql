...
(1, 'Página Sagrada', 'Página destinada a personagens religiosos', 1);
...
SELECT id, 1
FROM Personagem
WHERE profissao IN ('Acólito(a)', 'Paladino(a)', 'Clérigo(a)');

SELECT p.nome
FROM Personagem p
JOIN Personagem_Pagina pp ON pp.id_personagem = p.id
