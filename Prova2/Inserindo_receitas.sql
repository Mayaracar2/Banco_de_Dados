...
--nomes das receitas em ordem alfabética e quantos ingredientes diferentes são necessários para fazer cada receita.
SELECT
    r.nome AS nome_receita,
    COUNT(DISTINCT c.ingrediente) AS ingrediente_diferente
FROM
    Receitas r
JOIN
